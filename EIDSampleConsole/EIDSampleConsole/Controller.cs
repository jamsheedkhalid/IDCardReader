            ...
            try
            {
                ...
                if (readerManager.Readers.Length > 0)
                {
                    ...
                    if (reader.IsConnected())
                    {
                        ...
                        model.PhotoPath = "C:\\EID\\EID_PHO_" + model.EIDNumber.Replace(" ", "").Trim() + ".jpg";
                        ...
                        if (pDataEx.HolderSignatureImage != null)
                        {
                            ...
                            System.Drawing.Image image = System.Drawing.Image.FromStream(ms);
                            image.Save("C:\\EID\\EID_SIG_" + model.EIDNumber.Replace(" ", "").Trim() + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
                        }
                        model.HasData = true;
                    }
